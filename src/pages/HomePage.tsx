      ...
      try {
        ...
        try {
          ...
          setWeddingInfo({
            ...
            greetingMessage: weddingData.greetingMessage || `두 손 잡고 걷다보니 즐거움만 가득\n더 큰 즐거움의 시작에 함께 해주세요.\n\n지환, 윤진 결혼합니다.`
          });
        } catch (apiError) {
          // API 실패 시 기본값 사용
                      ...
                      {photos.map((_, index) => (
                        <button
                          ...
                          style={{
                            ...
                            borderRadius: '50%',
                            border: 'none',
                            background: index === mobileCurrentIndex ? 'white' : 'rgba(255, 255, 255, 0.5)',
                            cursor: 'pointer',
                    ...
                    {photos.map((photo, index) => (
                      <div
                        ...
                        style={{
                          ...
                          overflow: 'hidden',
                          cursor: 'pointer',
                          border: index === mobileCurrentIndex ? '2px solid #007AFF' : '2px solid transparent',
                ...
                {photos.map((photo, index) => (
                  <div
                    ...
                    style={{
                      ...
                      overflow: 'hidden',
                      cursor: 'pointer',
                      border: index === currentImageIndex ? '3px solid white' : '3px solid transparent',
                      transition: 'border 0.2s ease',
                      flexShrink: 0
                    }}
                  >
