...
import { getAllGroups, deleteGroup, updateGroup } from '../services/invitationService';
...
const AdminDashboard: React.FC = () => {
  ...
  // 기존 handleDeleteGroup 함수를 삭제하고 이 코드로 교체
const handleDeleteGroup = async (groupId: string) => {
  try {
    ...
    if (error.message && error.message.includes('응답이 있는')) {
      ...
      // 기타 에러
      alert(`그룹 삭제에 실패했습니다: ${error.message || '알 수 없는 오류'}`);
    }
  }
};
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              { title: '총 그룹 수', value: stats.totalGroups, icon: '👥', color: AppleColors.primary },
              { title: '예상 하객', value: stats.totalGuests, icon: '📊', color: AppleColors.secondary },
              { title: '실제 응답', value: stats.totalResponses, icon: '✅', color: AppleColors.success }
            ].map((stat, index) => (
              <div key={index} style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                backgroundColor: isEditingWeddingInfo ? AppleColors.destructive : AppleColors.primary,
                color: 'white',
                border: 'none',
                borderRadius: '10px',
                padding: '8px 16px',
            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setWeddingInfo({...weddingInfo, groomName: e.target.value})}
                  style={{
                    width: '100%',
                    padding: '12px 16px',
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setWeddingInfo({...weddingInfo, brideName: e.target.value})}
                  style={{
                    width: '100%',
                    padding: '12px 16px',
                    border: `1.5px solid ${AppleColors.border}`,
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setWeddingInfo({...weddingInfo, weddingTime: e.target.value})}
                  style={{
                    width: '100%',
                    padding: '12px 16px',
                    border: `1.5px solid ${AppleColors.border}`,
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <input
                  ...
                  onChange={(e) => setWeddingInfo({...weddingInfo, weddingLocation: e.target.value})}
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <input
                  ...
                  onChange={(e) => setWeddingInfo({...weddingInfo, address: e.target.value})}
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <textarea
                  ...
                  onChange={(e) => setWeddingInfo({...weddingInfo, greetingMessage: e.target.value})}
                  rows={4}
                  style={{
                    width: '100%',
                    padding: '12px 16px',
              ...
              <div style={{ 
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = AppleColors.secondaryButtonHover;
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = AppleColors.secondaryButton;
                  }}
                >
                  취소
                </button>
          ...
          {groups.length === 0 ? (
            <div style={{
              ...
              <div style={{ marginTop: '8px', fontSize: '14px' }}>
                상단의 "새 그룹 생성" 버튼을 클릭해서 첫 번째 그룹을 만들어보세요!
              </div>
            </div>
          ) : (
            <div style={{
                    ...
                    {editingGroupId === group.id ? (
                      <div>
                        ...
                        <div style={{
                          ...
                          <button
                            onClick={() => group.id && handleUpdateGreeting(group.id, editingGreeting)}
                            style={{
