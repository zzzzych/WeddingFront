...
const AdminDashboard: React.FC = () => {
  ...
  // 74번째 줄 근처의 기존 loadAllData 함수를 다음과 같이 완전히 교체하세요
  ...
  const loadAllData = async () => {
    try {
      ...
      // 임시 그룹 데이터 (기존 그룹과 동일하게 유지)
      const mockGroups: InvitationGroup[] = [
        {
          id: "1",
          groupName: "신랑 대학 동기",
          groupType: GroupType.WEDDING_GUEST,
          uniqueCode: "wedding123", // 실제 테스트용 코드로 변경
        },
        {
          id: "2",
          groupName: "신부 회사 동료",
          groupType: GroupType.WEDDING_GUEST,
          uniqueCode: "company789", // 실제 테스트용 코드로 변경
        },
        {
          id: "3",
          groupName: "부모님",
          groupType: GroupType.PARENTS_GUEST,
          uniqueCode: "parent456", // 실제 테스트용 코드로 변경
        },
      ];
